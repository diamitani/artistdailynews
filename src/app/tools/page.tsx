...
import { Calculator, DollarSign, BarChart2, Rocket } from "lucide-react";
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12 w-full">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold text-[var(--text-primary)] leading-tight">
            Stop Guessing Streaming Payouts, Catalogue Values & Release Dates
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
          <div className="card-brand p-6 space-y-3">
            <DollarSign className="w-6 h-6 text-[var(--accent-emerald)]" />
            <h3 className="font-serif font-bold text-[var(--text-primary)] text-lg">The Two Halves of Music</h3>
          ...
          <div className="card-brand p-6 space-y-3">
            ...
            <h3 className="font-serif font-bold text-[var(--text-primary)] text-lg">What Drives Multiples?</h3>
            <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
          ...
          <div className="card-brand p-6 space-y-3">
            ...
            <h3 className="font-serif font-bold text-[var(--text-primary)] text-lg">The 21-Day Pitch Rule</h3>
            <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
