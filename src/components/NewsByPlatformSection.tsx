...
const PLATFORMS: PlatformDefinition[] = [
  ...
  },
  {
    ...
    accentColor: "#6366F1",
    description: "Indie rock news, premiere track streams, festival line-ups, and in-depth artist interviews.",
    url: "https://stereogum.com",
    matches: (a) => a.sourceName.toLowerCase().includes("stereogum"),
  },
  {
    id: "thequietus",
    name: "The Quietus",
    category: "Experimental & Underground",
    badgeBg: "bg-zinc-500/10",
    badgeText: "text-zinc-300",
    borderColor: "border-zinc-500/30",
    accentColor: "#71717A",
    description: "Independent cultural criticism, experimental album retrospectives, and underground sound exploration.",
    url: "https://thequietus.com",
    matches: (a) => a.sourceName.toLowerCase().includes("quietus"),
  },
  {
    id: "digitalmusicnews",
    name: "Digital Music News",
    category: "Streaming & Copyright",
    badgeBg: "bg-sky-500/10",
    badgeText: "text-sky-400",
    borderColor: "border-sky-500/30",
    accentColor: "#0284C7",
    description: "Daily reporting on music tech lawsuits, streaming fraud crackdowns, and mechanical royalty distribution.",
    url: "https://digitalmusicnews.com",
    matches: (a) => a.sourceName.toLowerCase().includes("digital music news") || a.sourceName.toLowerCase().includes("dmn"),
  },
  {
    id: "hypebot",
    name: "Hypebot",
    category: "DIY Marketing & Tech",
    badgeBg: "bg-teal-500/10",
    badgeText: "text-teal-400",
    borderColor: "border-teal-500/30",
    accentColor: "#0D9488",
    description: "Actionable music marketing advice, D2C merchandising strategies, and music technology breakthroughs.",
    url: "https://hypebot.com",
    matches: (a) => a.sourceName.toLowerCase().includes("hypebot"),
  },
  {
    id: "trapital",
    name: "Trapital",
    ...
    accentColor: "#D97706",
    description: "Business essays and podcasts analyzing hip-hop, media empires, and creator economy business strategies.",
    url: "https://trapital.co",
    matches: (a) => a.sourceName.toLowerCase().includes("trapital"),
  },
  {
    id: "reddit",
    ...
    matches: (a) => a.sourceName.toLowerCase().includes("reddit") || a.sourceName.toLowerCase().includes("community") || a.sourceName.toLowerCase().includes("forum"),
  },
];
